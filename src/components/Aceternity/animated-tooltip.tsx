			...
			{items.map((item, idx) => (
				...
				>
					...
					<Image
						...
						src={item.logo}
						alt={item.name}
						className="relative !m-0 size-8 rounded-full border-2 border-white bg-black object-cover object-top !p-1.5 transition duration-500 group-hover:z-30 group-hover:scale-105"
					/>
				</div>
			))}
		</>
