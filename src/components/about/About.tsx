...
function About() {
	return (
		<div>
			<h2 id="about" className="mt-8 mb-8 text-center text-4xl lg:mb-0 lg:mt-0">
				About Me
			</h2>
				...
				<div className="mx-4 mt-8 flex-1 text-left md:mx-0 md:mt-0 md:p-6">
					<div className="flex flex-col gap-2.5">
						...
						<p className="text-sm font-semibold text-gray-600 md:text-lg dark:text-zinc-400">
							...
							designs or building sturdy back-end systems, I love turning ideas
							into reality with code. I&apos;m always up for learning new things
							and teaming up on exciting projects. Let&apos;s chat and see what
