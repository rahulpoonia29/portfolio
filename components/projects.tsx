	...
	return (
		...
		>
			<div className="flex flex-col gap-6">
				...
				<article className="group relative w-full overflow-hidden rounded-xl bg-zinc-50 dark:bg-zinc-900  border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors duration-200 border-2">
					<Link
